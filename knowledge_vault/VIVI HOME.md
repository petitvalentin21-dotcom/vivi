...
Nouveau projet VIVI recentré autour du MVP strict.
...
- interface dédiée simple ;
- LM Studio comme provider local ;
- chat local ;
- RAG Obsidian ;
- sources visibles ;
- runtime status ;
...
- 04_backlog : tâches et idées
- 05_runs : comptes rendus d’exécution
...
- [[01_user_docs/VIVI_MVP_REAL_ARCHITECTURE_MAP]]
- [[01_user_docs/VIVI_OBSIDIAN_RAG_GOVERNANCE]]
- [[01_user_docs/VIVI_DEVELOPER_OPERATIONS_MVP]]
- [[01_user_docs/VIVI_MVP_PRODUCT_OPERATING_PRINCIPLES]]
